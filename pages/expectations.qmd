...
1. **Team:** Be supportive of your labmates. We are a team.
...
1. **Presence:** We learn the most from one another! Group members should physically present in the office at least two days per week and be generally reachable by Slack during normal working hours. You should attend weekly group meetings.
1. **Produce open science:** see [Open Science](pages/open-science.qmd)
1. **See also:** Read and agree to the lab expectations (see the pages under "Lab Expectations") as well as to policies on [travel](pages/travel.qmd), [authorship](pages/authorship.qmd).
1. **Resolving issues:** If you have an issue with another lab member that cannot be solved by talking with them about it, please talk with James. If you have an issue with James, please reach out to another member of the department or the school of engineering.
...
1. **Provide Moral Support:** Graduate school, and research in general, can be an emotional roller coaster. James has been through these challenges personally and is always available to listen and provide advice (though you should also see the [Health Resources](pages/health.qmd) page).
